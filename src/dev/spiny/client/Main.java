...
import dev.spiny.client.impl.guice.ClientGuiceModule;
...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        // Whatever I dont have time to setup proper config parser cope evi

        final Injector injector = Guice.createInjector(new ClientGuiceModule(gameconfiguration));

        final Minecraft minecraft = injector.getInstance(Minecraft.class);
